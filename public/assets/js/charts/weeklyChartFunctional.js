/* 
this file is the working weekly chart.
the weeklyChart file right now is being manipulated to have an index at every day of the week
    currently, there is onoy an index at the points where there is an expense/
*/




export async function createWeeklyChart(data) {

// get existing chart instance
let weeklyChart = Chart.getChart("chart-filtered");
...
// destroy if exists
  ...
  const expenses = data.week_expenses;
  ...
  */
  ...
  weeklyChart = new Chart("chart-filtered", {
  type: "scatter",
  data: 
  {
    datasets: [
